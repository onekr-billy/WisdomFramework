<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="W.WebUI.Addins.Default" %>

<%@ Register Src="../HeadImport.ascx" TagName="HeadImport" TagPrefix="uc" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    
    <uc:HeadImport ID="HeadImport" runat="server" />
                    ...
                    <div class="page">
                        ...
                        <div class="pageFormContent" layouth="80" style="margin-right: 230px">
                            <p style="color: red">
                                DWZ官方微博 <a href="http://weibo.com/dwzui" target="_blank">http://weibo.com/dwzui</a></p>
                            <p style="color: red">
                                DWZ官方微群 <a href="http://q.weibo.com/587328/invitation=11TGXSt-148c2" target="_blank">
                                    http://q.weibo.com/587328/invitation=11TGXSt-148c2</a></p>
                            <div class="divider">
                            </div>
                            <h2>
                                dwz v1.2视频教程:</h2>
                            <p>
                                <a href="http://v.it-edu.cn/viewCourseDetail.do?courseId=50362" target="_blank">http://v.it-edu.cn/viewCourseDetail.do?courseId=50362</a></p>
                            <div class="divider">
                            </div>
                            <h2>
                                DWZ系列开源项目:</h2>
                            <div class="unit">
                                <a href="http://code.google.com/p/dwz/" target="_blank">dwz富客户端框架 - jUI</a></div>
                            <div class="unit">
                                <a href="http://code.google.com/p/dwz4j" target="_blank">dwz4j(Java Web)快速开发框架 + jUI整合应用</a></div>
                            <div class="unit">
                                <a href="http://code.google.com/p/j-hi" target="_blank">J-HI(Java Web)快速开发平台 + jUI整合应用（Eclipse插件生成项目代码）</a></div>
                            <div class="unit">
                                <a href="http://code.google.com/p/dwz4php" target="_blank">ThinkPHP2.1 + jUI整合应用</a></div>
                            <div class="unit">
...
定制化开发，公司培训，技术支持
    ...
    <div id="footer">
        Copyright &copy; 2010 <a href="demo_page2.html" target="dialog">DWZ研发组</a></div>
